...
if vendor == "ralink" or hwtype == "atheros" or hwtype == "mac80211" or hwtype == "prism2" then
...
if vendor == "ralink" or hwtype == "atheros" or hwtype == "mac80211" or hwtype == "prism2" then
	...
	if vendor == "ralink" then
		clientcert:depends({mode="sta", eap_type="tls", encryption="wpa-mixed"})
	end
	clientcert:depends({mode="sta-wds", eap_type="tls", encryption="wpa"})
	clientcert:depends({mode="sta-wds", eap_type="tls", encryption="wpa2"})
	if vendor == "ralink" then
		clientcert:depends({mode="sta-wds", eap_type="tls", encryption="wpa-mixed"})
	end
